...
# ======== Temas de color (fondos claros) ========
_THEMES = {
    "Azul":       {"primary": "#1e88e5", "bg": "#ffffff", "panel": "#f8fafc", "text": "#111827", "muted": "#6b7280"},
    "Verde Fénix (claro)": {"primary": "#38d430", "bg": "#ffffff", "panel": "#f8fafc", "text": "#111827", "muted": "#6b7280"},
    "Rojo claro": {"primary": "#ef4444", "bg": "#ffffff", "panel": "#f8fafc", "text": "#111827", "muted": "#6b7280"},
    "Negro (acento)": {"primary": "#111827", "bg": "#ffffff", "panel": "#f3f4f6", "text": "#111827", "muted": "#6b7280"},
    "Naranjo":    {"primary": "#f97316", "bg": "#ffffff", "panel": "#fff7ed", "text": "#111827", "muted": "#6b7280"},
    "Plateado":   {"primary": "#b0b5bd", "bg": "#ffffff", "panel": "#f3f4f6", "text": "#111827", "muted": "#6b7280"},
    "Dorado":     {"primary": "#d4af37", "bg": "#ffffff", "panel": "#fffbeb", "text": "#111827", "muted": "#6b7280"},
}

def _apply_theme(name: str):
    t = _THEMES.get(name, _THEMES["Verde Fénix (claro)"])
    css = f\"\"\"<style>
    :root {{
...
with st.sidebar:
    ...
    theme_choice = st.selectbox(
        "🎨 Tema de colores",
        list(_THEMES.keys()),
        index=list(_THEMES.keys()).index("Verde Fénix (claro)"),
        help="Cambia la paleta de colores (fondos claros)"
    )
